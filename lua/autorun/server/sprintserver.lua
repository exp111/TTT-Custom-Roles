...
-- Set ConVars
local Multiplier = CreateConVar("ttt_sprint_bonus_rel", "0.5", FCVAR_SERVER_CAN_EXECUTE, "The relative speed bonus given while sprinting. (0.1-2) Def: 0.5")
...
local RegenerateI = CreateConVar("ttt_sprint_regenerate_innocent", "0.15", FCVAR_SERVER_CAN_EXECUTE, "Sets stamina regeneration for innocents. (0.01-2) Def: 0.15")
local RegenerateT = CreateConVar("ttt_sprint_regenerate_traitor", "0.15", FCVAR_SERVER_CAN_EXECUTE, "Sets stamina regeneration speed for traitors. (0.01-2) Def: 0.15")
